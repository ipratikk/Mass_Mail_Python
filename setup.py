...
class Setup:
    ...
    def setup(self):
        self.setup_path()
        self.LOGFILE = os.path.join(self.DATA_PATH,f'Mass_Mail Log {datetime.now().strftime("%Y-%m-%d_%H-%M")}.log')
    ...
    def setup_path(self):
        ...
        if PLATFORM == "darwin":
            ...
            self.DATA_PATH = os.path.join(desktop_path,'Mass_Mail')
        elif PLATFORM == "win32":
            app_data_path = os.getenv("LOCALAPPDATA")
            temp_data_path = os.path.join(app_data_path,"Mass_Mail")
